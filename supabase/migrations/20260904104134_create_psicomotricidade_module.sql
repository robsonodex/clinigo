-- Migration: Create Psicomotricidade Module (World Sensory)
-- Date: 2026-09-04
...
-- SEED DATA FOR WORLD SENSORY
DO $$
DECLARE
    v_clinica_id uuid;
BEGIN
    SELECT id INTO v_clinica_id FROM public.clinics WHERE slug = 'world-sensory' LIMIT 1;
    ...
    IF v_clinica_id IS NOT NULL THEN
        ...
        (v_clinica_id, 'ERP02', 'Engajamento, Regulação e Participação', 'Seguir a sequência de atividades da rotina (___/___ etapas, máx. pista ☐verbal ☐gestual ☐visual)', '[{"tipo": "numero_ou_texto", "rotulo": "etapas corretas"}, {"tipo": "numero_ou_texto", "rotulo": "total de etapas"}, {"tipo": "selecao_unica", "rotulo": "máx. pista", "opcoes": ["verbal", "gestual", "visual"]}]'::jsonb),
        ...
        (v_clinica_id, 'ECC02', 'Esquema Corporal e Consciência Corporal', 'Imitar movimentos apresentados pelo profissional (___/___ mov., máx. pista gestual)', '[{"tipo": "numero_ou_texto", "rotulo": "acertos"}, {"tipo": "numero_ou_texto", "rotulo": "total"}]'::jsonb),
        ...
        (v_clinica_id, 'CMG04', 'Coordenação Motora Global', 'Transpor obstáculos com organização motora (___ obstáculos, ___/___ tent., máx. ajuda gestual)', '[{"tipo": "numero_ou_texto", "rotulo": "obstáculos"}, {"tipo": "numero_ou_texto", "rotulo": "acertos"}, {"tipo": "numero_ou_texto", "rotulo": "tentativas"}]'::jsonb),
        ...
        (v_clinica_id, 'EQP04', 'Equilíbrio e Controle Postural', 'Manter equilíbrio em superfície instável (___s, máx. ☐nenhuma ☐leve ☐moderada ajuda)', '[{"tipo": "numero_ou_texto", "rotulo": "segundos"}, {"tipo": "selecao_unica", "rotulo": "máx. ajuda", "opcoes": ["nenhuma", "leve", "moderada"]}]'::jsonb),
        ...
        (v_clinica_id, 'COM05', 'Coordenação Óculo-Manual e Óculo-Pedal', 'Acompanhar visualmente objeto em movimento (___/___ trajetórias apresentadas)', '[{"tipo": "numero_ou_texto", "rotulo": "acertos"}, {"tipo": "numero_ou_texto", "rotulo": "total"}]'::jsonb),
        ...
        (v_clinica_id, 'PMP04', 'Planejamento Motor / Praxia', 'Completar circuito motor previamente organizado (___ etapas, ___/___ tent., máx. pista ____)', '[{"tipo": "numero_ou_texto", "rotulo": "etapas"}, {"tipo": "numero_ou_texto", "rotulo": "acertos"}, {"tipo": "numero_ou_texto", "rotulo": "tentativas"}, {"tipo": "numero_ou_texto", "rotulo": "pista"}]'::jsonb),
        ...
        (v_clinica_id, 'ATR03', 'Agilidade e Tempo de Reação', 'Mudar rapidamente a direção do deslocamento (___/___ sem perda importante de equilíbrio)', '[{"tipo": "numero_ou_texto", "rotulo": "acertos"}, {"tipo": "numero_ou_texto", "rotulo": "total"}]'::jsonb),
