                            ...
                            <div className="relative h-48 rounded-2xl overflow-hidden group">
                                ...
                                {gallery.length > 1 && (
                                    <>
                                        <button
                                            onClick={prevImage}
                                            className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-xs p-2 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white"
                                        >
                                            <ChevronLeft className="w-5 h-5" />
                                        </button>
                                        <button
                                            onClick={nextImage}
                                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-xs p-2 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white"
                                        >
