...
import { User, Lock, Eye, EyeOff, Heart, Calendar, FileText, Clock, Smartphone, ArrowRight, Loader2 } from 'lucide-react'
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/recuperar-senha?portal=paciente" className="text-sm text-purple-600 hover:text-purple-700 font-medium">
                                Esqueci minha senha
                            </Link>
                        </div>
