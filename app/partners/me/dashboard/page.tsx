...
export default function PartnerMeDashboardPage() {
    ...
    const checkAuthAndFetchDashboard = async () => {
        try {
            ...
            // Fetch dashboard data using the user's partner ID
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <Card className="max-w-md">
                    <CardContent className="pt-6 text-center">
                        ...
                        <Button onClick={() => router.push('/partners/login')}>Fazer login</Button>
                    </CardContent>
                </Card>
            </div>
        )
                ...
                <Card className="mb-6 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white">
                    <CardContent className="pt-6">
                        ...
                        <p className="text-emerald-100 text-sm mt-4">
                            Compartilhe este código com clínicas para ganhar {dashboard.commission_rate}% de comissão
                        </p>
                    </CardContent>
                </Card>
