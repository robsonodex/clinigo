      ...
      {/* Header Premium Internacional */}
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-border">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl sm:text-2xl font-semibold text-foreground tracking-tight">Recebimentos de Operadoras</h1>
                        <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Integração de pagamentos, impostos retidos e glosas.</p>
                    </div>
                </div>
        <Dialog>
